 ...
 * @author Tnam1
 */
public class frmThoiKhoaBieuGiangVien extends javax.swing.JPanel {

    /**
     * Creates new form frmDongHocPhi
     */
    Database db;
    public frmThoiKhoaBieuGiangVien() {
        initComponents();
        db =new Database();
        NapThongTinHocKi();
        NapThongTinSinhVien();
    ...
    private void NapThongTinSinhVien()
    {
        ...
        try {
            ...
            Logger.getLogger(frmThoiKhoaBieuGiangVien.class.getName()).log(Level.SEVERE, null, ex);
        }
      ...
      private void NapDuLieutblLichGiangVaoTable()
    {
        try {
            ...
            String sSelect = "	SELECT IdDangKy as N'Mã Đăng Ký', TenMonHoc as N'Môn Học',TenThu as N'Thứ', Buoi as N'Buổi', TietBD as N'Tiết', TenPhong as N'Phòng',   TenHocKi as N'Học Kì' , SiSoHienTai as N'Số lượng Sinh Viên', SoTiet as N'Số Tiết', NgayBatDau as N' Ngày Bắt Đầu', NgayKetThuc as N'Ngày Kết Thúc'\n" +
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lblTen, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
...
"		  and DangKy.IdThoiGian=ThoiGianHoc.IdThoiGian\n" +
"		  and DangKy.IdPhong = PhongHoc.IdPhong\n" +
"		  and DangKy.IdThu = Thu.IdThu and Status = 1 and tblNguoiDung.IdNguoiDung = "+DangNhap.IdTk+" and  TenHocKi= N'"+cbKhoa.getSelectedItem().toString()+"'";
            ResultSet rs = db.TruyVan(sSelect);
            if(rs == null)
            {
                JOptionPane.showMessageDialog(this,"Không thể truy cập CSDL");
