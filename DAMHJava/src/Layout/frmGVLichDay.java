 ...
 * @author Tnam1
 */
public class frmGVLichDay extends javax.swing.JPanel {
     ...
     private void NapDuLieuXetMonDangKyVaoTable()
    {
        try {
            ...
            String sSelect = "	SELECT IdDangKy as N'Mã Đăng Ký', TenMonHoc as N'Môn Học',TenThu as N'Thứ', Buoi as N'Buổi', TietBD as N'Tiết', TenPhong as N'Phòng',   TenHocKi as N'Học Kì' , SiSoHienTai as N'Số lượng Sinh Viên', SoTiet as N'Số Tiết'\n" +
...
"		  and DangKy.IdThu = Thu.IdThu and Status = 1 and tblNguoiDung.IdNguoiDung = "+DangNhap.IdTk+"";
    ...
    private void btnTimkiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimkiemActionPerformed
        ...
        if(cbMon.getSelectedIndex() != 0  && cbHocKi.getSelectedIndex() ==0)
        {
            try {
                DefaultTableModel modelTable = new DefaultTableModel();
                String sSelect = "	SELECT IdDangKy as N'Mã Đăng Ký', TenMonHoc as N'Môn Học',TenThu as N'Thứ', Buoi as N'Buổi', TietBD as N'Tiết', TenPhong as N'Phòng',   TenHocKi as N'Học Kì' , SiSoHienTai as N'Số lượng Sinh Viên', SoTiet as N'Số Tiết'\n" +
...
"		  and DangKy.IdThu = Thu.IdThu and Status = 1 and tblNguoiDung.IdNguoiDung = "+DangNhap.IdTk+" and TenMonHoc = N'"+cbMon.getSelectedItem().toString()+"'";
       ...
       else if(cbMon.getSelectedIndex() == 0 && cbHocKi.getSelectedIndex() !=0)
        {
            try {
                DefaultTableModel modelTable = new DefaultTableModel();
                String sSelect = "	SELECT IdDangKy as N'Mã Đăng Ký', TenMonHoc as N'Môn Học',TenThu as N'Thứ', Buoi as N'Buổi', TietBD as N'Tiết', TenPhong as N'Phòng',   TenHocKi as N'Học Kì' , SiSoHienTai as N'Số lượng Sinh Viên', SoTiet as N'Số Tiết'\n" +
