 ...
 * @author Tnam1
 */
public class frmThemHocPhan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cbPhong, javax.swing.GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jLabel8, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(cbHocKi, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        if( SiSo.equals("0") && cbGiangVien.getSelectedIndex() == 0 &&cbBuoi.getSelectedIndex() == 0 && cbHocKi.getSelectedIndex() ==0 && cbMon.getSelectedIndex() == 0 && cbPhong.getSelectedIndex() == 0 && cbThu.getSelectedIndex() == 0)
        {
        ...
        else
        {
            ...
            try {
                 ...
                 while(rs.next())
                {
                 ...
                 String sSQL1 = "SELECT IdNguoiDung FROM tblNguoiDung WHERE HoTen = N'"+cbGiangVien.getSelectedItem().toString()+"'";
                ResultSet rs2 = db.TruyVan(sSQL1);
                if(rs2== null) 
                {
                    JOptionPane.showMessageDialog(this,"Không truy vấn được trong CSDL");
                    return;
            ...
            ResultSet rs1 = db.TruyVan(check);
             ...
             if(!ktra.equals("0"))
             {
                 String add ="INSERT INTO DangKy(IdMonHoc,IdThu,IdThoiGian,IdHocKi,IdPhong,IdGV, Status,SiSo) VALUES("+mon+","+thu+","+buoi+","+hocki+","+phong+","+gv+",1,'"+SiSo+"')";
        ...
        else
        {
          int mon=0; int gv=0;
            ...
            ResultSet rs1 = db.TruyVan(check);
             ...
             if(!ktra.equals("0"))
             {
                 String add ="UPDATE DangKy SET IdMonHoc = "+mon+",IdThu = "+thu+",IdThoiGian = "+buoi+",IdHocKi = "+hocki+",IdPhong = "+phong+",SiSo ="+SiSo+", IdGV= "+gv+"  WHERE  IdDangKy ="+maPhong+"";
                 int i = db.ThemXoaSua(add);
                 if(i > 0)
                 {
